...
Gem::Specification.new do |spec|
  ...
  spec.add_dependency "activemodel", "4.2.7.1" # NOTE: 5.0.0.1 gives internal NoMethodError
  ...
  spec.add_development_dependency "rubocop", "0.45.0" # was: "~> 0.39"
  spec.add_development_dependency "simplecov", "0.12.0"
  spec.add_development_dependency "pry-byebug", "3.4.0"
  spec.add_development_dependency "pry-doc", "0.9.0"
  # NOTE: spec.add_development_dependency "colorize", "~> 0.7", ">= 0.7.7"
