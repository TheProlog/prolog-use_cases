...
usecase_setup_runtime_gems() {
  ...
  gem install activemodel -v 4.2.7.1 # NOTE: 5.0.0.1 gives internal NoMethodError
  gem install semantic_logger -v 3.2.1
...
usecase_setup_dev_gems() {
  ...
  gem install rubocop -v 0.45.0 # was: 0.39.0
